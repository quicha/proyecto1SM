...
class bpchat_Database_Manager {
    ...
    public function create_custom_tables() {
        global $wpdb;
        $table_name = $wpdb->prefix . "bpchat_message";
        ...
        $wpdb->query("ALTER TABLE $wpdb->users 
			ADD COLUMN bpchat_status VARCHAR(50) NOT NULL AFTER display_name,
			ADD COLUMN bpchat_last_activity TIMESTAMP DEFAULT CURRENT_TIMESTAMP AFTER bpchat_status");
    }
