...
if ( ! class_exists( 'bpchatOptions' ) ) {
	class bpchatOptions {
			
		function __construct() {
			$this->create_bpchat_Options();
		}
		
		public function create_bpchat_Options() {
			...
			*/
			$config = array(    
				...
				'page_title'     => __('bpchat options','apc'),       //The name of this page 
				'capability'     => 'edit_themes',         // The capability needed to view the page 
				'option_group'   => 'bpchat_options',       //the name of the option to create in the database
			...
			*/
			...
			'links' => array(
			  ...
			  'options_6' =>  __('Translation',MC_TEXT_DOMAIN),
			...
			*/
			...
			$options_panel->addColor('bpc_friend_title_color',array('name'=> __('Friend title color ','apc'), 'std' => '', 'desc' => __('Friend title text color','apc')));
			...
			$options_panel->addRadio(
				...
				array(
					'bg0'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg0.png" />',
					'bg1'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg1.png" />',
					'bg2'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg2.png" />',
					'bg3'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg3.png" />',
					'bg4'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg4.png" />',
					'bg5'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg5.png" />',
					'bg6'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg6.png" />',
					'bg7'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg7.png" />',
					'bg8'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg8.png" />',
					'bg9'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg9.png" />',
					'bg10'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg10.png" />',
					'bg11'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg11.png" />',
					'bg12'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg12.png" />',
					'bg13'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg13.png" />',
					'bg14'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg14.png" />',
					'bg15'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg15.png" />',
					'bg16'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg16.png" />',
					'bg17'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg17.png" />',
					'bg18'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg18.png" />',
					'bg19'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg19.png" />',
					'bg20'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg20.png" />',
					'bg21'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg21.png" />',
					'bg22'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg22.png" />',
					'bg23'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg23.png" />',
					'bg24'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg24.png" />',
					'bg25'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg25.png" />',
					'bg26'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg26.png" />',
					'bg27'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg27.png" />',
					'bg28'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg28.png" />',
					'bg29'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg29.png" />',
					'bg30'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg30.png" />',
					'bg31'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg31.png" />',
					'bg32'=>'<img class="bpc-radio-image" src="'.BPC_URL.'images/bg/bg32.png" />',
					'none'=>'none',
				),
				array(
			...
			*/
			//title
			$options_panel->Title(__('Refresh Options - W-P-L-O-C-K-E-R-.-C-O-M','apc'));
			...
			*/
			...
			$options_panel->addText('bpc_lg_search_friends', array('name'=> __('Search friends','apc'), 'std'=> 'Search friends', 'desc' => __('','apc')));			
