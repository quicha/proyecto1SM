...
<section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
	...
	foreach( $partners as $partner ){
		...
		if( $links[$j] != '' ){
			 $html .= '<div class="col-md-'.$col.'"><a target="_blank" href="'.esc_url($links[$j]).'" ><img  data-placement="top" data-toggle="tooltip" title="'.esc_attr( $titles[$j]).'" src="'.esc_url($partner).'" alt="'.esc_attr( $titles[$j]).'"></a></div>';
		}else{
			 $html .= '<div class="col-md-'.$col.'"><img data-placement="top" data-toggle="tooltip" title="'.esc_attr( $titles[$j]).'" src="'.esc_url($partner).'" alt="'.esc_attr( $titles[$j]).'"></div>';
		}
