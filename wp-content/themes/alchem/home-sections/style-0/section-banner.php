<?php 
 ...
 $youtube_mute = 'false';
  ...
  $section_class = 'section magee-section alchem-home-section-0 alchem-home-style-0';
  if( $content_model == 3 )
            ...
            <section  class="section magee-section section-banner fullheight verticalmiddle" style="background-image: url(<?php echo $image;?>);background-repeat:repeat;">
              <div class="section-content">
                <div class="container">
                  ...
                  <?php if( $btn_text!='' ):?>
                  <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class=" magee-btn-normal btn-md btn-line btn-light"><?php echo $btn_text;?></a>
                     <?php endif;?>
                  </div>
                </div>
              </div>
