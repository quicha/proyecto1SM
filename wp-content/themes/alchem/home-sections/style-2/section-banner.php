<?php 
 ...
 $youtube_mute = 'false';
  ...
  $section_class = 'section magee-section alchem-home-section-0 alchem-home-style-2';
  if( $content_model == 3 )
        ...
        <div id="" class=" row">
          <div class="col-md-6">
            <div class="<?php echo $alchem_home_animation;?>" data-animationduration="0.9" data-animationtype="bounce" data-imageanimation="no" id="">
              <h1 class="magee-heading" id=""><span class="heading-inner" style="font-family: 'Poiret One'"><?php echo do_shortcode($title);?></span></h1>
            </div>
            <p style="text-align:center; color: #fff; font-size: 20px;"><?php echo do_shortcode($sub_title);?></p>
            <div style="height:30px;"></div>
            <div style="text-align:center;">
            <?php if( $btn_text!='' ):?>
              <a href="<?php echo $btn_link;?>" target="<?php echo $btn_target;?>" class=" magee-btn-normal btn-full-rounded btn-md btn-line" id=""><?php echo $btn_text;?></a>
              <?php endif;?>
              </div>
          </div>
