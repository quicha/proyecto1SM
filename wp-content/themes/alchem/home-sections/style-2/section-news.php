<?php 
  // section news 
   ...
   $section_class = 'section magee-section alchem-home-section-8 alchem-home-style-2';
 ...
 <section class="<?php echo $section_class;?>" id="<?php echo $section_id;?>">
  ...
  <?php if( $section_title != '' ):?>
    ...
    <?php endif;?>
    <div class="<?php echo $alchem_home_animation;?>" data-animationduration="1.2" data-animationtype="fadeIn" data-imageanimation="no">
     <?php
	 $news_item   = '';
	 $news_str    = '';
	 $j           = 0;
