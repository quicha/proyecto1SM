 ...
 */
/**
 * Include the MP_Profit_TGM_Plugin_Activation class.
 */
require_once dirname(__FILE__) . '/class-tgm-plugin-activation.php';

add_action('tgmpa_register', 'mp_profit_register_required_plugins');
 ...
 * MP_Profit_TGM_Plugin_Activation class constructor.
 */
function mp_profit_register_required_plugins() {
    /*
    ...
    array_push($plugins, array(
        'name' => 'Profit Theme Engine',
        'slug' => 'mp-profit',
		'is_callable' => 'mp-profit',
            )
    );
    array_push($plugins, array(
...
add_action('admin_head', 'mp_profit_admin_style');

function mp_profit_admin_style() {
    echo '<style>
    #setting-error-tgmpa{
        display:block;
    } 
