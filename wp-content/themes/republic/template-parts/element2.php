...
<?php
$getcateid3 = get_theme_mod('republic_catechoose3');?>
	<div class="large-12 column level three">
	<!---Title of Index Elements-->
		<span class="label front-label three">
			<a href="<?php echo esc_url( get_category_link( $getcateid3 ) ); ?>" title="<?php echo get_cat_name($getcateid3); ?>"><?php if($getcateid3){ echo get_cat_name($getcateid3); } else { echo 'Category 3'; } ?></a>
		</span>
		<a href="<?php echo esc_url( get_category_link( $getcateid3 ) ); ?>" class="viewposts" title="<?php echo get_cat_name($getcateid3); ?>"><?php _e('View all','republic'); ?> <i class="fa fa-caret-right"></i></a>
	</div>
<?php
