...
<?php
$getcateid1 = get_theme_mod('republic_catechoose1'); ?>
	<div class="large-12 column level one">
	<!---Title of Index Elements-->
		<span class="label front-label one">
			<a href="<?php echo esc_url( get_category_link( $getcateid1 ) ); ?>" title="<?php echo get_cat_name($getcateid1); ?>"><?php if($getcateid1){ echo get_cat_name($getcateid1); } else { echo 'Category 1'; } ?></a>
		</span>
		<a href="<?php echo esc_url( get_category_link( $getcateid1 ) ); ?>" class="viewposts" title="<?php echo get_cat_name($getcateid1); ?>"><?php _e('View all','republic'); ?> <i class="fa fa-caret-right"></i></a>
	</div>
