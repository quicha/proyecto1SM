...
function ghostpool_insert_shortcode() {
	...
	var style = document.getElementById( 'style_panel' );
		...
		if ( styleid != 0 && styleid == 'activity' ) {
			tagtext = '['+ styleid + ' header="Latest Activity" post_form="enabled" scope="" per_page="5" comments="threaded" allow_comments="false" order="desc" pagination="true"]';	
		}
		...
		*/
		...
		if ( styleid != 0 && styleid == 'image' ) {
			tagtext = '['+ styleid + ' url="" width="" height="" crop="true" link="" target="" border="false" align="alignleft" margins="" alt="" title="" lightbox="none" preload="false" classes=""]';	
		}
		...
		if ( styleid != 0 && styleid == 'posts' ) {
			tagtext = '['+ styleid + ' content="post" cats="" ids="" images="true" image_width="200" image_height="150" image_wrap="true" hard_crop="true" cols="1" per_page="5" link="both" orderby="date" order="desc" offset="" content_display="excerpt" excerpt_length="700" title="true" title_size="" title_font="" meta="true" read_more="true" pagination="true" preload="false" spacing="spacing-normal" header=""]';	
		}
		...
		if ( styleid != 0 && styleid == 'related_posts' ) {
			tagtext = '['+ styleid + ' widget_title="" content="post" cats="" id="" images="true" image_width="139" image_height="120" image_wrap="false" hard_crop="true" cols="3" per_page="3" link="both" orderby="rand" order="desc" offset="" content_display="excerpt" excerpt_length="0" title="true" title_size="12" title_font="" meta="false" read_more="false" pagination="false" preload="false" spacing="spacing-normal"]';	
		}
		...
		if ( styleid != 0 && styleid == 'slider' ) {
			tagtext = '['+ styleid + ' content="slide" cats="" ids="" width="1003" height="480" hard_crop="true" slides="-1" timeout="6" orderby="menu_order" order="asc" buttons="true" content_display="excerpt" excerpt_length="0" title="true" title_length="40" margins="" align="aligncenter" preload="false"]';	
		}
